...
public class SkillBridgeServer {
    ...
    // ============================================================
    static final String DATA_FILE = System.getenv("DATA_PATH") != null ? System.getenv("DATA_PATH") : "skillbridge_data.json";
    static final int    PORT = System.getenv("PORT") != null
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("\u2560" + "\u2550".repeat(58) + "\u2563");
        String envPort = System.getenv("PORT") != null ? System.getenv("PORT") : "8080";
        System.out.println("\u2551  Listening on port : " + envPort + "                          \u2551");
    ...
    static void setCors(HttpExchange ex) {
        ...
        ex.getResponseHeaders().add("Access-Control-Allow-Origin", origin != null ? origin : "*");
